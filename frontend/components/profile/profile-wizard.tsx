    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          {STEPS.map((s) => {
            ...
            return (
              <div key={s.id} className="flex flex-col items-center flex-1">
                ...
                <span
                  className={`text-xs font-medium uppercase tracking-wider ${active ? "text-primary" : "text-muted-foreground"}`}
                >
                  {s.label}
                </span>
      ...
      <Card className="border-none shadow-2xl overflow-hidden glass min-h-[500px] flex flex-col">
        <CardHeader>
          ...
          <CardDescription>
            {step === 1 &&
              "Upload your resume to auto-fill your profile details. We support PDF, DOCX, and TXT."}
            {step === 2 &&
              "Basic information helps us find roles that match your experience level."}
            {step === 3 &&
              "Add your technical skills to get better job recommendations."}
            {step === 4 &&
              "Double-check everything before we generate your personalized career plan."}
          </CardDescription>
        </CardHeader>
                ...
                <div className="flex items-center space-x-2 py-4 p-4 border rounded-lg bg-muted/30">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setForm({ ...form, is_career_switcher: checked })
                    }
                  />
                  <div className="space-y-1">
                    <Label htmlFor="career-switcher" className="cursor-pointer">
                      I am a Career Switcher
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      Highlight transferable skills matching different domains.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {COMMON_SKILLS.map((skill) => (
                      <Badge
                        key={skill}
                        variant={
                          form.skills.includes(skill) ? "default" : "outline"
                        }
                ...
                {form.skills.length > 0 && (
                  <div className="p-4 bg-muted/30 rounded-lg">
                    <h3 className="text-sm font-medium mb-2">
                      Your Selected Skills ({form.skills.length})
                    </h3>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div className="flex items-center justify-between border-b pb-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {form.education === "bachelor"
                          ? "Bachelor's Degree"
                          : form.education}{" "}
                        • {form.years_experience} Years Exp
                      </p>
                    </div>
                    {form.is_career_switcher && (
                      <Badge variant="secondary">Career Switcher</Badge>
                    )}
                  </div>
