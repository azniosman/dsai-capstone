...
export function PromptInput({ className, onPromptSubmit, loading, ...props }: PromptInputProps) {
            ...
            <div className="flex items-center justify-between px-3 pb-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        className={cn("transition-all duration-200", value.trim() ? "bg-primary text-primary-foreground shadow-[0_0_10px_hsl(var(--primary)/0.5)]" : "opacity-50")}
                    >
